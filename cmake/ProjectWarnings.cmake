...
function(set_project_warnings TARGET)
  ...
  option(GK_ENABLE_COVERAGE "Enable coverage reporting for gcc/clang" OFF)

  if(CMAKE_COMPILER_IS_GNUCC)
    if(GK_ENABLE_COVERAGE)
  ...
  if(MSVC)
        if (GK_ENABLE_STRICT_COMPILE)
                ...
                ${TARGET}
                INTERFACE /WX # treat warnings as errors
                )
        endif()

    target_compile_options(
      ${TARGET}
      INTERFACE /W4 # Baseline reasonable warnings
        ...
        if (GK_ENABLE_STRICT_COMPILE)
                target_compile_options(
                ${TARGET}
                INTERFACE -Werror # treat warnings as errors
                )
        endif()
