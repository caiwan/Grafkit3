...
#ifndef _GRAFKIT_VKS_INITILAIZERS_
#define _GRAFKIT_VKS_INITILAIZERS_
...
namespace Grafkit::Core::Initializers {
	...
	inline VkImageCreateInfo ImageCreateInfo(
		const VkImageType imageType, const VkExtent3D extent, const VkFormat format, const VkImageUsageFlags usage)
	{
		VkImageCreateInfo imageCreateInfo {};
		imageCreateInfo.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
	...
	inline VkImageViewCreateInfo ImageViewCreateInfo(
		const VkExtent3D extent, const VkFormat format, const VkImageUsageFlags usage)
	{
		VkImageViewCreateInfo imageViewCreateInfo {};
		imageViewCreateInfo.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
		return imageViewCreateInfo;
